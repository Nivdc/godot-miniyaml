# MiniYAML
MiniYAML - A GDScript port of PyYAML.
...
This is because the `write_indent()` method of the PyYAML `Emitter` is not perfect, which has been fixed in ruamel-yaml. However, the new implementation is a bit complicated, and I haven't had time to fix this issue yet.
